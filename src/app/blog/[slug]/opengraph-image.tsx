...
import { BLOG_POSTS_BY_SLUG } from "@/lib/seo-content";
    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ color: "rgba(248,250,252,0.92)", fontSize: 50, lineHeight: 1.08, fontWeight: 700 }}>
            {title}
          </div>
